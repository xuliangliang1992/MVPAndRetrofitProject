package com.xll.mvplib.dialog.base;
...
import com.xll.mvplib.dialog.animator.BaseAnimatorSet;
...
public abstract class BottomTopBaseDialog<T extends BottomTopBaseDialog<T>> extends BaseDialog<T> {
    ...
    protected void showWithAnim() {
        if (mInnerShowAnim != null) {
            ...
            ll_control_height.startAnimation(mInnerShowAnim);
        }
    ...
    protected void dismissWithAnim() {
        if (mInnerDismissAnim != null) {
            ...
            ll_control_height.startAnimation(mInnerDismissAnim);
        } else {
            superDismiss();
        }
